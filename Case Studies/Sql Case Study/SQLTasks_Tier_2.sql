...
SELECT DISTINCT CASE WHEN members.firstname != members.surname 
                THEN CONCAT(members.firstname, ' ', members.surname)
                ELSE  members.firstname END AS Members,
...
SELECT Members, facility_name, cost
FROM (
SELECT DISTINCT 
CASE WHEN members.firstname != members.surname
THEN CONCAT(members.firstname, ' ', members.surname)
ELSE  members.firstname END AS Members,
      facilities.name AS facility_name,  
